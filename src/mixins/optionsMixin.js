export const optionsMixin = {
  ...
  methods: {
    ...
    getArea () {
      let params ={
          _select: 'id as "value", nome as "label"',
          sort: 'nome',
          dir: 'asc',
      };
      return this.$api.get(`/area`, {params})
    },
    getMotivo () {
      let params ={
          _select: 'motivo_id as "value", descricao as "label"',
          sort: 'descricao',
          dir: 'asc',
      };
    ...
    getCentroCusto () {
      let params ={
          _select: 'centro_custo_id as "value", descricao as "label"',
          sort: 'descricao',
          dir: 'asc',
        };
        return this.$api.get(`/centro_custo`, {params})
    },
